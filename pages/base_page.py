...
class BasePage:
    """
    BasePage chuẩn cho POM:
    - Đặt timeout mặc định từ settings
    - Goto an toàn cho URL có/không có hash
    - Helper locator đa dạng
    - Hành động (click/fill/select/press/hover/scroll/upload) có wait & retry
    - Tiện ích assert URL, đợi/toast
    """
